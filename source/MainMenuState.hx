...
class MainMenuState extends MusicBeatState
{
	...
	public static var socksEngineVersion:String = '0.1'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "Socks Engine v" + socksEngineVersion, 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("VCR OSD Mono", 16, 0xFF007300, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				...
				else
				{
					...
					FlxTween.tween(FlxG.camera, {zoom: 2}, 0.7, {ease: FlxEase.expoIn});
